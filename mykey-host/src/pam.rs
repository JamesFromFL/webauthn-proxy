...
// Messaging protocol.
//
// PAM service file: /etc/pam.d/mykey  (created by scripts/install.sh)
...
/// PAM authentication against the "mykey" service.
///
...
pub fn verify_user_presence() -> bool {
    ...
    let mut client = match pam::Client::with_conversation("mykey", conv) {
        Ok(c) => c,
        Err(e) => {
